                ...
                <div className="container-fluid h-100">
                  ...
                  <div className="row align-items-center h-100">
                    ...
                    <div className="col-xl-6">
                      ...
                      <Link to={`https://wa.me/${process.env.REACT_APP_CONTACT_NUMBER}`} target='_blank' className='btn purpleBtn rounded'>Solicite um Orçamento <IoChevronForward /></Link>
                ...
                <div className="container-fluid h-100">
                  ...
                  <div className="row align-items-center h-100">
                    ...
                    <div className="col-xl-6">
                      ...
                      <Link to={`https://wa.me/${process.env.REACT_APP_CONTACT_NUMBER}`} target='_blank' className='btn purpleBtn rounded'>Fale com um Especialista <IoChevronForward /></Link>
