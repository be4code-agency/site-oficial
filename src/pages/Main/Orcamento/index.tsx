      ...
      <section className="row">
        ...
        <div className="col-md-6 mb-3 mb-md-0" data-aos="zoom-in" data-aos-delay="100">
          ...
          <Container bgTheme="dark">
            ...
            <Link to={`https://wa.me/${process.env.REACT_APP_CONTACT_NUMBER}`} target="_blank" className="btn btn-lg rounded purpleBtn shadowBtn">Solicitar orçamento agora <IoChevronForwardOutline /></Link>
        ...
        <div className="col-md-6" data-aos="zoom-in" data-aos-delay="150">
          ...
          <Container bgTheme="light">
            ...
            <Link to={`https://wa.me/${process.env.REACT_APP_CONTACT_NUMBER}`} target="_blank" className="btn btn-lg rounded darkPurpleBtn">Solicitar orçamento agora <IoChevronForwardOutline /></Link>
