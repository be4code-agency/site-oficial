        ...
        <div className="row">
          ...
          <div className="col-12">
            ...
            <div className="d-flex flex-column gap-4 flex-md-row justify-content-evenly align-items-center w-100 white">
              ...
              <a data-aos="fade-left" href={`https://wa.me/5511974808118?text=${msgWhatsapp}`} target="_blank" rel="noreferrer" className="btn btn-lg btn-outline-light">Solicitar um Orçamento <IoChevronForwardOutline /></a>
